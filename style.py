...
class Style:
    ...
    def open_image(self, name1, name2):
        ...
        self.combination_image = backend.placeholder((1, self.IMAGE_HEIGHT, self.IMAGE_SIZE, 3))
    ...
    def train(self, name1="images/images/input1.png", name2="images/images/style.png"):

        self.open_image(name1, name2)
